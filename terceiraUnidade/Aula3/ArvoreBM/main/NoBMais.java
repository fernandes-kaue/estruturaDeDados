...
public class NoBMais<C extends Comparable<C>, V> {
    ...
    /**
     * Construtor para um nó da árvore B+.
     *
     * @param folha true se é um nó folha, false caso contrário
     */
    ...
    public void setChaves(List<C> chaves) {
        this.chaves = chaves;
    }
    public List<V> getValores() {
        return valores;
    }
    public void setValores(List<V> valores) {
        this.valores = valores;
    }
    public List<NoBMais<C, V>> getFilhos() {
        return filhos;
    }
    public void setFilhos(List<NoBMais<C, V>> filhos) {
        this.filhos = filhos;
    }
    public NoBMais<C, V> getProximo() {
        return proximo;
    }
    public void setProximo(NoBMais<C, V> proximo) {
    ...
    public boolean estaCheio(int ordem) {
