package primeiraUnidade.Aula2.PilhaEstaticaDuplaManual;

public class PilhaDuplaManual implements EmpilhavelDupla {
    //variáveis de instância
    private int ponteiroTopo1;
    private int ponteiroTopo2;
    private Object[] dados;

    public PilhaDuplaManual(int tamanho) {
        ponteiroTopo1 = -1;
        ponteiroTopo2 = tamanho;
        dados = new Object[tamanho];
    }

    public PilhaDuplaManual() {
        this(10);
    }
